...
class AnimalAdapter:RecyclerView.Adapter<AnimalAdapter.AnimalHolder>() {
    ...
    override fun onCreateViewHolder(parent : ViewGroup, viewType : Int): AnimalHolder { // СОЗДАЕТ НАШУ РАЗМЕТКУ И СОЗДАЁТ КЛАСС FlowerHolder // теперь разметка в памяти и можно ее заполнить
